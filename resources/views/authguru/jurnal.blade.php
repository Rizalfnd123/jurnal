    ...
    <div class="content">
        <div class="animated fadeIn">
            ...
            <div class="bg-white p-3 rounded-lg shadow-lg mb-4"> <!-- Kecilkan padding -->
                <a href="{{ url('/jadwal-hari-ini-guru') }}"
                    class="block bg-amber-900 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded-full text-center text-sm">
                            ...
                            @foreach ($jurnal as $item)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-2 px-4 space-x-2">
                                        ...
                                        <a href="{{ url('jurnal-guru/' . $item->id . '/edit') }}"
                                            class="text-blue-500 hover:text-blue-700 text-xs">
                                            <i class="fa fa-pencil"> Edit</i>
                                        </a>
                                        <form action="{{ url('jurnal-guru/' . $item->id) }}" method="post"
