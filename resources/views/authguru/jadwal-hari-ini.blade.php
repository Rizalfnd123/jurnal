                        ...
                        @foreach ($jadwalToday as $item)
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-2 px-4 flex space-x-1">
                                    <!-- Tombol Isi Jurnal -->
                                    <a href="{{ route('jurnal-guru.create', ['id' => $item->id]) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded text-xs">
                                        Isi Jurnal
                                    </a>
                                    <!-- Tombol Isi Izin -->
                                    <a href="{{ url('izin-guru/create', ['id' => $item->id]) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-2 rounded text-xs">
                                        Isi Izin
                                    </a>
                                </td>
                            </tr>
