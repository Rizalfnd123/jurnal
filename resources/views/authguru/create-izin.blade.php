            ...
            <div class="max-w-4xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden mb-3">
                <div class="p-2">
                    <div class="flex justify-between">
                        ...
                        <a href="{{ url('izin-guru') }}" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded transition duration-300">
                            <i class="fa fa-undo"></i> Kembali
                        </a>
                    </div>
                </div>
                <div class="p-4">
                    <form action="{{ url('izin-guru') }}" method="post" enctype="multipart/form-data" class="shadow-lg p-6 bg-gray-50 rounded-lg">
                        @csrf
