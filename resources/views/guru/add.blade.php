                    ...
                    <div class="col-md-4 offset-md-4">
                        <form action="{{ url('guru') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>NIP</label>
                                <input type="text" name="nip" class="form-control" autofocus required>
                                ...
                                <!-- Kondisi untuk menampilkan preview jika ada -->
                                @if(isset($guru->foto))
                                    <img id="preview" src="{{ asset('images/' . $guru->foto) }}" alt="Preview Foto" style="display:block; width: 150px; margin-top: 10px;" />
                                @else
                                    <img id="preview" src="#" alt="Preview Foto" style="display:none; width: 150px; margin-top: 10px;" />
                                @endif
                            </div>
