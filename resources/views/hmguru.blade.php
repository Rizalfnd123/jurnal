        ...
        <div class="flex items-center justify-between">
            ...
            <div class="relative">
                <button id="profile-dropdown" class="flex items-center">
                    <img 
                        src="{{ asset('images/' . ($guru->foto ?? 'admin.jpg')) }}" 
                        alt="Profile" 
...
<script>
    const sekolahLat = -7.1253764; // Ganti dengan latitude sekolah
    const sekolahLon = 112.7224567; // Ganti dengan longitude sekolah
